...
inoreabbr <silent> <buffer> coalesce <C-R>=SqlIab_ReplaceConditionally('coalesce', 'COALESCE')<CR>
...
inoreabbr <silent> <buffer> full <C-R>=SqlIab_ReplaceConditionally('full', 'FULL')<CR>
...
inoreabbr <silent> <buffer> max <C-R>=SqlIab_ReplaceConditionally('max', 'MAX')<CR>
inoreabbr <silent> <buffer> maxextents <C-R>=SqlIab_ReplaceConditionally('maxextents', 'MAXEXTENTS')<CR>
inoreabbr <silent> <buffer> min <C-R>=SqlIab_ReplaceConditionally('min', 'MIN')<CR>
...
inoreabbr <silent> <buffer> over <C-R>=SqlIab_ReplaceConditionally('over', 'OVER')<CR>
inoreabbr <silent> <buffer> path <C-R>=SqlIab_ReplaceConditionally('path', 'PATH')<CR>
inoreabbr <silent> <buffer> partition <C-R>=SqlIab_ReplaceConditionally('partition', 'PARTITION')<CR>
...
inoreabbr <silent> <buffer> right <C-R>=SqlIab_ReplaceConditionally('right', 'RIGHT')<CR>
...
inoreabbr <silent> <buffer> round <C-R>=SqlIab_ReplaceConditionally('round', 'ROUND')<CR>
...
inoreabbr <silent> <buffer> sum <C-R>=SqlIab_ReplaceConditionally('sum', 'SUM')<CR>
...
inoreabbr <silent> <buffer> trunc <C-R>=SqlIab_ReplaceConditionally('trunc', 'TRUNC')<CR>
...
inoreabbr <silent> <buffer> rundate TO_DATE('{RUN_DATE_YYYYMMDD}','YYYYMMDD')
inoreabbr <silent> <buffer> megadate DATE('{MEGA_PARAMETER_RUNDATE}')
